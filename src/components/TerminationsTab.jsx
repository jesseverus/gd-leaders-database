...
<div style={{fontSize:13,color:T.hint,marginBottom:12}}>GD Terminations &amp; Resignations · {terminations.length} total records · All years collapsed by default</div>
...
{!isCollapsed(year)&&<div style={{marginTop:4,display:"flex",flexDirection:"column",gap:3}}>
