...
{!collapsed[year]&&<div style={{marginTop:4,display:"flex",flexDirection:"column",gap:4}}>
...
<div style={{flex:"0 0 110px",fontSize:12,color:T.hint}}>Promo: <span style={{color:T.text}}>{fmtShort(t.promoDate)||"—"}</span></div>
